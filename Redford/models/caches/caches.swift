...
class Caches {
  ...
  static let avatars = BaseCache<ImageRequest>(cacheLimit: 100, cache: ["t2_Redford_sample":.init(data: ImageRequest(url: URL(string: "https://Redford.cafe/icons/iconExplode.png")!), createdAt: Date())])
